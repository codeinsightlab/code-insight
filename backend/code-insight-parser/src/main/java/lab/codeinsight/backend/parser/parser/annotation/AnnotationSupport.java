...
public final class AnnotationSupport {
  ...
  /** Resolves first mapping path from value/path attributes of mapping annotations. */
  ...
  /** Resolves HTTP method from composed mapping annotations or RequestMapping.method. */
