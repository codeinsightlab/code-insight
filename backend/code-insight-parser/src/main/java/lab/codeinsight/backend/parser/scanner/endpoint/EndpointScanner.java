...
public class EndpointScanner {
  ...
  public List<EndpointInfo> scan(List<ControllerInfo> controllers, List<JavaSourceFile> javaSourceFiles) {
    ...
    for (ControllerInfo controller : controllers) {
      Optional<ClassOrInterfaceDeclaration> declarationOpt =
          findControllerDeclaration(controller, javaSourceFiles);
  ...
  private Optional<ClassOrInterfaceDeclaration> findControllerDeclaration(
      ControllerInfo controller, List<JavaSourceFile> javaSourceFiles) {
